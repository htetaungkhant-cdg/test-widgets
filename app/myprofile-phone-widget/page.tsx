import MyProfilePhoneWidgetWebComponent from "@/components/MyProfilePhoneWidgetWebComponent";

export default async function PhoneWidgetPage() {
  return (
    <div className="bg-white flex flex-col gap-y-6 items-center justify-center min-h-screen py-2">
      <h1 className="prose-heading-2xl text-center text-primary">
        Porsche Phone Widget
      </h1>

      <div>
        <div className="flex flex-col gap-y-4 items-center">
          <p className="text-center text-primary prose-text-md">
            &quot;myprofile-phone-widget&quot; is 👇🏻.
          </p>
          <div className="bg-primary p-4 rounded-md">
            <MyProfilePhoneWidgetWebComponent
              token={
